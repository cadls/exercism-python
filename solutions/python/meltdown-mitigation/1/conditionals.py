...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    product_emmitted = temperature * neutrons_emitted
    
    if temperature < 800 and neutrons_emitted > 500 and product_emmitted < 500000:
        return True
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if reactor_value < threshold * 0.9:
        return 'LOW'
    elif 0.9 * threshold <= reactor_value <= 1.1 * threshold:
        return 'NORMAL'
    else:
        return 'DANGER'
